...
if __name__ == '__main__':
    Fractions = [
        Fraction(.3424),
        Fraction(.1),
        Fraction(321241241412.514513412),
        Fraction('23131.321'),
        Fraction('312,9575423'),
        Fraction(1, 2),
        Fraction(873, -432),
        Fraction(42342),
        Fraction(-3212.342),
        Fraction('-432.93842'),
        Fraction('43241424,213')
    ]
    print(*Fractions, sep='\n')
    ...
    a += b
    print((8-a)/17*3)
    print(2/Fraction('5/-2'))
    print(Fraction(Fraction(Fraction(a))))
    print(int(a))
    print(float(a))
    print(a*-1, abs(a*-1))
    print(a ** 4)
    print(a, a ** -1)
    print(2 == Fraction('124/62'))
    print(Fraction.simplify(1024, 64*7))
    c = Fraction(4124.4124)
    print(c)
    c._numerator = 10
    print(c, c*1)
    d = Fraction('33/125')
