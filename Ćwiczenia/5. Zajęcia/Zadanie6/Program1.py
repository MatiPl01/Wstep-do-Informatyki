...
if __name__ == '__main__':
    ...
    print(Complex(5j))
    print(Complex(8j))
    print(Complex("3214-4i"))
    c1 = Complex(8j)
    print(c1.as_trigonometric())
    print(c1, c1**2)

    # (((6+.524i)+(123-54i)*.1)/(65-8i))**3
    print(as_degrees((((Complex('6+.524j') + Complex('123-54j') * .1) / Complex('65-8j'))**3).arg()))
    ...
    results = c2**.5
    print(*results)
    print(*(c.as_trigonometric(as_fraction=False) for c in results))
    print(*(as_degrees(c.arg()) for c in results))

    print(Complex(4, 1).root(.25))
    print(as_degrees(Complex(8).arg()))
    # print(Complex(0, 0).arg())
    print(Complex('4+i'), Complex('4-j'), Complex('+i'), Complex('-i'), Complex('2'), Complex('j'))
    print(Complex('6.000+1.i'))
